...
% Code for plotting uxur reconstruction
...
annotation('textbox', [pt1{1}(1) pt1{1}(2)+pt1{1}(4)+0.02 0.03 0.03], 'interpreter','latex', 'String', str, 'FontSize',20, 'Edgecolor', 'none');
...
hYLabel = ylabel('$\langle -u''_{x}u''_{r} \rangle$','interpreter','latex','fontsize', 20, 'Position', [-0.5, 0.0006, 0]); %#ok<*NASGU>
...
hXLabel = xlabel('$r/L_{k}$','interpreter','latex','fontsize',20, 'position', [1.4, -0.000011, 0]);
hYLabel = ylabel('$\langle -u''_{x}u''_{r} \rangle$','interpreter','latex','fontsize',20, 'Position', [-0.5, 0.00007, 0]);
% hYLabel = ylabel('$\langle -u^''_{x}u^''_{r} \rangle$','interpreter','latex','fontsize',15);
...
hXLabel = xlabel('$r/L_{k}$','interpreter','latex','fontsize',20, 'position', [1.4, -0.000008, 0]);
