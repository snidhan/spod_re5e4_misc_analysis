...
f_fit = f(ix1:ix2);
eigvalue_fit = eigvalues_spectrum_plot(2).eigvalue(ix1:ix2,1);
...
hold on;
loglog(f_fit, 10^-5*f_fit.^coeffs(1), 'k--', 'Linewidth',2);
text(1.5, 10^-5,'$\mbox{\textit{St}}^{-2.86}$','interpreter','latex','FontSize', 20);
...
f_fit = f(ix1:ix2);
eigvalue_fit = eigvalues_spectrum_plot(5).eigvalue(ix1:ix2,1);
...
text(1.5, 10^-5,'$\mbox{\textit{St}}^{-2.45}$','interpreter','latex','FontSize', 20);
...
f_fit = f(ix1:ix2);
eigvalue_fit = eigvalues_spectrum_plot(3).eigvalue(ix1:ix2,1);
...
hold on;
loglog(f_fit, 10^-5*f_fit.^coeffs(1), 'k--', 'Linewidth',2);
text(1.5, 10^-5,'$\mbox{\textit{St}}^{-2.88}$','interpreter','latex','FontSize', 20);
...
f_fit = f(ix1:ix2);
eigvalue_fit = eigvalues_spectrum_plot(6).eigvalue(ix1:ix2,1);
...
hold on;
loglog(f_fit, 5*10^-6*f_fit.^coeffs(1), 'k--', 'Linewidth',2);
text(1.5, 10^-5,'$\mbox{\textit{St}}^{-2.50}$','interpreter','latex','FontSize', 20);
...
%% Saving the plot
set(gcf, 'PaperPositionMode', 'auto');
print(gcf,strcat(dirout, 'eigenspectrum_m12_x_D_20_80_withslopes.png'),'-dpng','-r600');  
print(gcf,strcat(dirout, 'eigenspectrum_m12_x_D_20_80_withslopes.eps'),'-depsc','-r600');
