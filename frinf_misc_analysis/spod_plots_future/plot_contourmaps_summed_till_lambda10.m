...
filename = './aux_plots/files/eigvalue_contourf_diff_loc.mat';
load(filename);
...
h1 = contourf(eigvalues_contourf_plot(1).FREQ(1:24,:), ...
              ...
              squeeze(sum((eigvalues_contourf_plot(1).eigvalue(1:24,1:20,1:6)),2)), ...
...
h1 = contourf(eigvalues_contourf_plot(2).FREQ(1:24,:), ...
              ...
              squeeze(sum((eigvalues_contourf_plot(2).eigvalue(1:24,1:20,1:6)),2)), ...
            'Linestyle', 'none'); %#ok<*NASGU>
...
h1 = contourf(eigvalues_contourf_plot(3).FREQ(1:24,:),...
              ...
              squeeze(sum((eigvalues_contourf_plot(3).eigvalue(1:24,1:20,1:6)),2)), ...
            'Linestyle', 'none'); %#ok<*NASGU>
...
h1 = contourf(eigvalues_contourf_plot(4).FREQ(1:24,:), eigvalues_contourf_plot(4).MODE(1:24,:), ...
              squeeze(sum((eigvalues_contourf_plot(4).eigvalue(1:24,1:20,1:6)),2)), ...
            'Linestyle', 'none'); %#ok<*NASGU>
...
%% Save the plot
set(gcf, 'PaperPositionMode', 'auto');  
print(gcf,strcat(dirout, 'contourf_allmf_x_D_spod_summed_1_20','.png'),'-dpng','-r600');
print(gcf,strcat(dirout, 'contourf_allmf_f_x_D_spod_summed_1_20','.eps'),'-depsc','-r600');
