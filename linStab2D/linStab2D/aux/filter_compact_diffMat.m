function [M,D] = filter_compact_diffMat(nx,order,alpha_f)
...
switch order
    ...
    case 2
        ...
        f_dw1_f =  3/4 + alpha_f/4;
        f_dw1_g =  1/2 + alpha_f/2;
        f_dw1_h = -1/4 + alpha_f/4;
        f_dw1_i = 0;
        f_dw1_j = 0;
        f_dw1_k = 0;
        f_dw1_l = 0;
    ...
    case 4
        ...
        f_dw2_e = 1/16 + 7*alpha_f/8;
        f_dw2_f = 3/4 + alpha_f/2;
        f_dw2_g = 3/8 + alpha_f/4;
        f_dw2_h =-1/4 + alpha_f/2;
        f_dw2_i = 1/16 - alpha_f/8;
        f_dw2_j = 0;
        f_dw2_k = 0;
        f_dw2_l = 0;
        f_dw2_m = 0;
        ...
        f_dw1_f = 15/16 + alpha_f/16;
        f_dw1_g = 1/4 + 3*alpha_f/4;
        f_dw1_h =-3/8 + 3*alpha_f/8;
        f_dw1_i = 1/4 - alpha_f/4;
        f_dw1_j =-1/16 + alpha_f/16;
        f_dw1_k = 0;
        f_dw1_l = 0;
        f_dw1_m = 0;
        f_dw1_n = 0;
        ...
        f_dw1_p = 0;      
    otherwise
        error(['Filter order ' num2str(order) 'not supported']);
end
...
figure
subplot(1,2,1)
f       = sin(x) + 0.3*rand(1,nx);
plot(x,f,x,M\(D*f')), legend('f','$M^{-1}Df$'); title('random noise')
subplot(1,2,2)
f       = sin(x) + 0.3*(-1).^(1:nx);
plot(x,f,x,M\(D*f')), legend('f','$M^{-1}Df$'); title('wiggle')
